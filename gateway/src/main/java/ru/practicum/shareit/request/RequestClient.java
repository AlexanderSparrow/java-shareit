...
public class RequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> createNewRequest(Long userId, ItemRequestDto requestDto) {
        return post("", userId, requestDto);
    }

    public ResponseEntity<Object> findAllRequestsByUserWithResponses(Long userId) {
        return get("", userId);
    }
